...
Indic_choice = MultiChoice(options=["100 Day SMA", "30 Day SMA", "Linear Regression Line"])
...
layout = column(stock1_text, stock2_text, date_picker_from, date_picker_to, Indic_choice, load_button)
